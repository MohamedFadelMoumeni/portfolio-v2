...
import WorkCard from "./ui/work-card.component";

const Resume = () => {
  return (
    <div className="w-full bg-slate-800 py-10 md:py-20 " id="resume">
      <Container>
        <h1 className="text-5xl text-white font-bold mb-6">My Resume.</h1>
        ...
        <div className="w-full">
          <h1 className="text-red-500 text-2xl font-semibold">Experience</h1>
